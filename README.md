# Practica-3-ESP32-con-DHT22-y-LCD
Realizar un codigo que arroje 3 pantallazos en la LCD

# Descripccion
Mostrar en el LCD 3 pantallazos que arrojen lo sieguente;
1. Bienvenidos y Modulo 5
2. Nombre y Carrera
